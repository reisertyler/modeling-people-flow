...
class VisualizerCreator:
    ...
    def __init__(self, start_date, end_date, config_file="config.json"):
        ...
        self.timeseries_configs = ["Config1", "Config2", "Config3", "Config4","Config5", "Config6"]
        self.campus_configs = ["campus-plotter1","campus-plotter2","normalized-campus-plotter","dorm-average","general-average","community-average"]
